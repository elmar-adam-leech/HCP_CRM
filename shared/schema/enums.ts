...
export const workflowTriggerTypeEnum = pgEnum("workflow_trigger_type", ["entity_created", "entity_updated", "status_changed", "field_changed", "time_based", "manual", "estimate_option_approved", "estimate_option_rejected", "estimate_stale", "payment_received", "deposit_received", "lead_reply_received", "estimate_reply_received", "job_reply_received"]);
